document.addEventListener("DOMContentLoaded", function () {
    carregarCarrinhoDoLocalStorage(); // Carregue o carrinho do localStorage quando a página for carregada
    atualizarCarrinho();
    ...
    // Chame esta função no início do seu código para carregar o carrinho quando a página for carregada
    ...
    function atualizarCarrinho() {
      ...
      let mensagem =
        "Olá, estou interessado em fazer uma compra! Meu carrinho: \n \n";
      itens.forEach((item) => {
      ...
      const numeroTelefone = "98985133216"; // Substitua pelo seu número de telefone
